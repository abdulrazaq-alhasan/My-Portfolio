...
const meta = {
    ...
    description:
        "I'm Abdulrazaq Alhasan, a Frontend Developer specializing in React, Next.js, Redux Toolkit, and Tailwind CSS.",
};
...
const introdata = {
    ...
    description:
        'Passionate about creating fast, responsive, and scalable web applications with modern frontend technologies.',
    your_img_url:
...
const dataabout = {
    ...
    aboutme:
        'Frontend Developer based in Västerås, Sweden, passionate about building modern, responsive, and user-friendly web applications. I enjoy learning new technologies, solving problems, and creating clean, maintainable code with React, JavaScript, and Vue.',
};
...
const services = [
    {
        title: 'UI & UX Design',
        description:
            'I design clean and modern user interfaces focused on usability, responsiveness, and user experience.',
    },
    {
        title: 'Frontend Development',
        description:
            'I build responsive and interactive web applications using React, JavaScript, TypeScript, and modern frontend tools.',
    },
    {
        title: 'Wordpress Design',
        description:
            'I create and customize WordPress websites with a focus on performance, responsiveness, and clean design.',
    },
];
...
const dataportfolio = [
    {
        ...
        link: 'https://react-ecommerce-umber-ten.vercel.app/',
...
const contactConfig = {
    ...
    description:
        'I’m always open to discussing new opportunities, projects, or collaborations in frontend development. Feel free to reach out anytime.',
